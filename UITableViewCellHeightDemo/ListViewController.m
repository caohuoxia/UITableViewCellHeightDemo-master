...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([RedPacketCell class]) bundle:nil] forCellReuseIdentifier:ReuseIdentifier];
    //5.autolayout 方法动态计算cell高度
...
{
    RedPacketCell *cell = [tableView dequeueReusableCellWithIdentifier:ReuseIdentifier forIndexPath:indexPath];
